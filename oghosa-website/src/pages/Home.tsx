...
import BBBLogo from '../../public/static/blue-seal-153-100-oghosahomehealthcare-b8fbfd2.png';
import HealthCareImage from '../../public/static/nursing-home.png';
import TransportationImage from '../../public/static/van.png';
  ...
  return (
    <>
      ...
      <section className="relative h-screen">
        {/* Background Image */}
        <img
          src="public/static/homepage.png"
      ...
      <div className="container mx-auto">
        ...
        <div ref={ref4} className={`md:flex md:justify-between md:items-center transition-opacity ease-in duration-700 ${isVisible4 ? "opacity-100" : "opacity-0"}`}>
          ...
          <div className="md:w-1/3 flex justify-center md:justify-end">
            <img
              src="public/static/transportation1.jpg"
              alt="quality"
        ...
        <div ref={ref5} className={`mt-12 md:flex md:justify-between md:items-center bg-blue-50 p-8 mb-12 rounded-lg transition-opacity ease-in duration-1000 ${isVisible5 ? "opacity-100" : "opacity-0"}`}>
          <div className="md:w-1/2">
            <img
              src="public/static/independent-client.png"
